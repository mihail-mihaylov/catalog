 ...
 *     boundaryIds: Array.<number>}}
    ...
    Dygraph.prototype.resize = function(width, height) {
        width = document.getElementsByClassName("graphs")[0].clientWidth - 100; // CHANGED: Responsive graphs
        height = 320; // CHANGED: Responsive graphs
 ...
 *   'always'}) and with dashed lines.
    ...
    legend.generateLegendHTML = function(g, x, sel_points, oneEmWidth, row) {
        ...
        html = xvf.call(g, x, xOptView, labels[0], g, row, 0).replace(/\//g, '.'); // CHANGED: Set custom format for date in the legend
