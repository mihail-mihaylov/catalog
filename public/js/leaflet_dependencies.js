...
L.Control.FullScreen = L.Control.extend({
	...
	onAdd: function (map) {
		...
		if(map.zoomControl) {
			...
			className = '-fullscreen leaflet-bar-part leaflet-bar-part-bottom last tip-right fullscreen-map-button';
		...
		this._createButton('Увеличи', containerClass + className, container, this.toogleFullScreen, map);
...
//# sourceMappingURL=leaflet_dependencies.js.map
