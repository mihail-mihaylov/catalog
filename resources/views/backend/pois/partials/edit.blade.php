<div class="tabs-container">
    <form class="form-horizontal" data-submit method='PUT' data-table-name="pois_table" action="{{ route('pois.update', ['id' => $poi->id]) }}" >
    ...
    <input type="hidden" class="response_coordinates" value="{{ $poi->toJson() }}">
