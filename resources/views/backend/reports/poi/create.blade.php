...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                {!! Form::open(['url' => route('reports.poi.report'), 'method' => 'POST', 'class' => '']) !!}
                    <div class="ibox-title">
                        <h5>
                            <i class="fa fa-bar-chart-o"></i>&nbsp;
                            {{ trans('reports.create_poi_report') }}
                        </h5>
                    </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-2">
                                    {!! Form::label('poi', trans_choice('poi.poi', 1), ['class' => 'control-label']) !!}
                                </div>

                                <div class="col-md-5">
                                    <select class="select-pois form-control fix-select2" name="poi" >
                                        <option value="">{{ trans('general.please_choose') }}</option>
                                        @foreach ($pois as $poi)
                                            <option value="{{ $poi->id }}">
                                                {{ $poi->translation->first()->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
